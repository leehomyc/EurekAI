...
```bash
# Install
git clone https://github.com/leehomyc/EurekAI.git
mkdir -p ~/.claude/skills/
cp -r EurekAI/skills/eureka-idea ~/.claude/skills/
...
EurekAI integrates as Phase 2 of the [`/idea-creator`](skills/idea-creator/SKILL.md) skill, replacing generic brainstorming with eureka-style deep thinking:
...
| Traditional brainstorming | EurekAI |
|--------------------------|---------|
...
EurekAI learns these recurring patterns from the 116 papers:
...
Ideas generated by EurekAI (Claude Opus 4.6 + `top_papers_cot.json`):
...
If you use EurekAI in your research, please cite:

```bibtex
@misc{yang2026eurekai,
    author       = {Yang, Harry},
    title        = {EurekAI: Research Idea Generation via Chain-of-Thought Emulation of Landmark Papers},
    year         = {2026},
...
EurekAI builds on the skill infrastructure of [ARIS (Auto-claude-code-research-in-sleep)](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep) — an autonomous ML research workflow system by Ruofeng Yang, Yongcan Li, and Shuai Li.
