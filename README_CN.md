...
> **⚠️ 方案 B 额外步骤：** Codex MCP 使用 OpenAI 的 Responses API (`/v1/responses`)，MiniMax 不支持该接口（[详情](https://github.com/openai/codex/discussions/7782)）。因此方案 B 使用**自定义 MiniMax MCP 服务器**替代 Codex。你需要：
>
...
> ```
>
> 完整指南：[`docs/MINIMAX_MCP_GUIDE.md`](docs/MINIMAX_MCP_GUIDE.md)
